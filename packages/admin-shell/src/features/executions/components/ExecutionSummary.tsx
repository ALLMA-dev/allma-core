// packages/allma-admin-shell/src/features/executions/components/ExecutionSummary.tsx
        ...
        <Paper withBorder p="lg" mb="xl" shadow="sm">
            ...
            <SimpleGrid cols={{ base: 1, sm: 2, md: 4 }}>
                <Box>
                    ...
                    <Text fw={500}>{metadata.flowDefinitionId} (v{metadata.flowDefinitionVersion})</Text>
                </Box>
                <Box>
