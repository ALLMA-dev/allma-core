...
import { IconAlertCircle, IconGauge, IconListDetails, IconActivity, IconPrompt, IconTemplate, IconPlugConnected, IconUserCog, IconTool, IconChartBar } from '@tabler/icons-react';
...
import type { AllmaPlugin, PluginNavItem } from './types/plugin';
import { DashboardPage } from './features/dashboard/DashboardPage';
import { StepDefinitionListPage } from './features/step-definitions/StepDefinitionListPage';
import { FlowListPage } from './features/flows/FlowListPage';
import { FlowEditorPage } from './features/flows/editor/FlowEditorPage';
import { FlowVersionListPage } from './features/flows/FlowVersionListPage';
...
import { PromptCreatePage } from './features/prompts/PromptCreatePage';
import { PromptVersionListPage } from './features/prompts/PromptVersionListPage';
import { PromptComparePage } from './features/prompts/PromptComparePage';
import { StepDefinitionCreatePage } from './features/step-definitions/StepDefinitionCreatePage';
import { StepDefinitionEditPage } from './features/step-definitions/StepDefinitionEditPage';
...
function ProtectedApp({ plugins }: AuthenticatedAppProps) {
  ...
  const coreNavLinks: (PluginNavItem & { permission: AdminPermission, icon: React.ComponentType<{ size: string }> })[] = [
    ...
    { label: 'Statistics', path: '/statistics', icon: IconChartBar, permission: AdminPermission.DASHBOARD_VIEW },
