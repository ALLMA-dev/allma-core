...
export interface SupplierSummary {
  ...
  // Extended fields for the Global Supplier Directory
  titanNo?: string;
  responsible?: string;
  ...
  products?: string;
  materials?: string;
  developmentCapabilities?: string;
  contactName?: string;
  contactEmail?: string;
  contactPhone?: string;
...
/**
 * @description The complete view model for `GET /views/supplier-detail/:id`.
 */
export interface SupplierDetailViewModel {
  supplier: SupplierSummary;
  supplierFields: MasterField[];
}

/**
 * @description A categorized grouping of commodities for UI display.
 * Returned by `GET /views/commodities-list`.
 */
export interface CategorizedCommodityViewModel {
  category: string;
