...
export const determineNextSfnAction = (
    ...
    if (nextStepType === StepType.POLL_EXTERNAL_API) {
        // The pollingTaskInput is generated by the *current* step's handler result,
        // which should be stored in the internal state.
        const currentStepHandlerResult = runtimeState._internal?.currentStepHandlerResult;
        return { 
            sfnAction: SfnActionType.POLL_EXTERNAL_API,
            pollingTaskInput: currentStepHandlerResult?.specializedOutput
        };
    }
